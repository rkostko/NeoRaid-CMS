    ...
    */
    ...
    editor : function(elem, options) {
        ...
        */
        ...
        this._html = $(elem).val();
        this._html = (jQuery(elem).get(0).tagName.toLowerCase() == 'textarea')? jQuery(elem).val() : jQuery(elem).html();
        ...
        this._options.skinPath = this._options.basePath + this._options.skinPath;

        // set css and js skin paths
        this._options.cssCompiledSkinPath = this._options.cssCompiledSkinPath || this._options.cssSkinPath || this._options.skinPath;
        this._options.jsCompiledSkinPath = this._options.jsCompiledSkinPath || this._options.jsSkinPath || this._options.skinPath;
...
WYMeditor.editor.prototype.computeBasePath = function() {
  var path = jQuery(jQuery.grep(jQuery('script'), function(s){
