...
jQuery.fn.wymeditor = function(options) {
  ...
  options = jQuery.extend({
    ...
    toolsHtml: "<div class='wym_tools wym_section' style='border 1px red'>"
              + "<h2>{Tools}</h2>"
              + "<ul>"
    ...
    galleryHtml:        "<div class='wym_containers wym_section'>"
                        + "<h2>Images</h2>"
...
boxHtml = h.replaceAll(boxHtml, WYMeditor.GALLERY, this._options.galleryHtml);
...
WYMeditor.editor.prototype.update = function() {
  ...
  var html = this.xhtml();
  if(jQuery(this._element).get(0).tagName.toLowerCase() == 'textarea')
  {
...
WYMeditor.INIT_DIALOG = function(index) {
  ...
  case WYMeditor.DIALOG_IMAGE:
    ...
    /*//alert(wym._options.imagesGallery); 
