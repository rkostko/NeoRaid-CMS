...
(function( $ ){
  ...
  $.fn.jrac = function(options) {
    ...
    return this.each(function() {
      ...
      var dialog_title = $container.parent().prev().find('.coords');
      ...
      $('<img>').attr('src', $image.attr('src')).ready(function(){
...
//alert(event_name);
            $(dialog_title).find("."+event_name).text(value);
            $(dialog_title).find("input[name="+event_name+"]").val=value;
//alert($(dialog_title).find("input[name="+event_name+"]").attr("type"));
