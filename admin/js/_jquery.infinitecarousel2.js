		...
		var options = $.extend(defaults, options);
			...
			if(o.showControls)
			{
				...
				if(!o.prevNextInternal)
				{
					...
					$('#'+wrapID).css('margin','0 auto 0 auto');
				}

				// Prev/next button(img)
				arrowsTop = ((imgHeight/2)-22)+parseInt(o.padding);
				html = '<div id="btn_rt'+randID+'" style="position:absolute;right:-16px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:66px;height:65px;background:url('+o.imagePath+'leftright.png) no-repeat 33px 0"></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute;left:-16px;top:'+arrowsTop+'px;cursor:pointer;border:none;width:66px;height:65px;background:url('+o.imagePath+'leftright.png) no-repeat -33px 0"></div>';
